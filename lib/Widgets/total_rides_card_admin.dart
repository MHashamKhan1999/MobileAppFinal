...
class TotalRidesCard extends StatefulWidget {
  const TotalRidesCard({Key? key}) : super(key: key);

  @override
  State<TotalRidesCard> createState() => _TotalRidesCard();
}

class _TotalRidesCard extends State<TotalRidesCard> {
  @override
